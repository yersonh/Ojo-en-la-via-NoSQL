...
async function guardarReporteEditado(form) {
    ...
    try {
        ...
        const respuesta = await fetch('/views/usuario/reportes/controladores/editar_reporte.php', {
            method: 'POST',
            body: formData
        });
...
async function eliminarReporteAlerta(tarjeta) {
    ...
    try {
        const respuesta = await fetch('/views/usuario/reportes/controladores/eliminar_reporte.php', {
            method: 'POST',
            body: formData
        });
